-- Script per estendere la tabella gruppi_pamm con i nuovi campi basati su Excel gruppi DEF
-- Creato da Ezio Camporeale per Dashboard Matematico Prop/Broker
...
-- Inserire dati di esempio basati su Excel gruppi DEF
...
('Gruppo 1', 'frank andre', 1, 'PAMM001', 12000.0, 1, 'MANUEL CARINI [4000]', 4000.0, 'mancanza saldo', '', 1, 1, 'frank andre', 12000, 25.0, 'admin', 'admin'),
('Gruppo 1', 'frank andre', 1, 'PAMM001', 12000.0, 1, 'MIRKO CARINI [8000]', 8000.0, 'mancanza saldo', '', 1, 1, 'frank andre', 12000, 25.0, 'admin', 'admin'),

-- Gruppo 2: 10k membri (mario)
('Gruppo 2', 'mario', 1, 'PAMM002', 10000.0, 4, 'LUIGI GUGLIELMELLI (2404)', 2404.0, 'Svolto', 'Depositata', 1, 1, 'mario', 10000, 25.0, 'admin', 'admin'),
('Gruppo 2', 'mario', 1, 'PAMM002', 10000.0, 4, 'VITO ZONNO [801]', 801.0, 'Svolto', 'Depositata', 1, 1, 'mario', 10000, 25.0, 'admin', 'admin'),
('Gruppo 2', 'mario', 1, 'PAMM002', 10000.0, 4, 'VINCENZO VOZZA [972]', 972.0, 'Svolto', 'Depositata', 1, 1, 'mario', 10000, 25.0, 'admin', 'admin'),
('Gruppo 2', 'mario', 1, 'PAMM002', 10000.0, 4, 'MARIO MAZZA 2 [2000]', 2000.0, 'Svolto', '', 1, 1, 'mario', 10000, 25.0, 'admin', 'admin'),

-- Gruppo 3: 7k membri (fede trott|mario)
('Gruppo 3', 'fede trott|mario', 1, 'PAMM003', 7000.0, 5, 'MIRKO MINATI RIZZI [1876]', 1876.0, 'Svolto', 'Depositata', 1, 1, 'fede trott|mario', 7000, 25.0, 'admin', 'admin'),
('Gruppo 3', 'fede trott|mario', 1, 'PAMM003', 7000.0, 5, 'SILVIA SAMMARTANO [1887]', 1887.0, 'Svolto', 'Depositata', 1, 1, 'fede trott|mario', 7000, 25.0, 'admin', 'admin'),
('Gruppo 3', 'fede trott|mario', 1, 'PAMM003', 7000.0, 5, 'PIERA ANDRANI [1000]', 1000.0, 'Non svolto', '', 1, 1, 'fede trott|mario', 7000, 25.0, 'admin', 'admin'),
('Gruppo 3', 'fede trott|mario', 1, 'PAMM003', 7000.0, 5, 'PAOLA PIRAS [1000]', 1000.0, 'Non svolto', '', 1, 1, 'fede trott|mario', 7000, 25.0, 'admin', 'admin'),
('Gruppo 3', 'fede trott|mario', 1, 'PAMM003', 7000.0, 5, 'MAURIZIO PETRACHI [1000]', 1000.0, 'Non svolto', '', 1, 1, 'fede trott|mario', 7000, 25.0, 'admin', 'admin')

ON CONFLICT (id) DO NOTHING;

-- Verificare la struttura della tabella aggiornata
SELECT 
    column_name, 
    data_type, 
    is_nullable, 
